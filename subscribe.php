...
if (!$syncResult['ok']) {
    // O lead já está no banco (e o e-mail comercial, se SMTP estiver ok).
    // Não devolve 502 pro visitante — ele veria erro mesmo com a solicitação salva.
