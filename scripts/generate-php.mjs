...
const pages = [
  ...
  },
  {
    ...
    pageTitleExpr: "'Montagem de Palco para Eventos | ' . SITE_NAME",
    pageDescriptionExpr: "'Empresa de montagem de palco para eventos corporativos, shows, formaturas e casamentos. Estruturas modulares, coberturas e equipe técnica em SP.'",
    ...
    'name'        => 'Montagem de Palco para Eventos',
    'serviceType' => 'Montagem de palco e estruturas para eventos',
    'description' => 'Montagem de palco para eventos corporativos, shows, formaturas e casamentos: estruturas modulares, coberturas, praticáveis e equipe técnica em São Paulo.',
    'provider'    => ['@id' => SITE_URL . '/#organization'],
    'areaServed'  => 'BR',
]`,
    faqItems: [
      ['Por que contratar uma empresa de montagem de palco especializada?', 'Contratar uma empresa especializada garante que a estrutura siga normas de segurança, cálculo de carga e nivelamento correto. Além disso, evita imprevistos técnicos durante o evento.'],
      ['Qual o prazo médio para a montagem de palco para show ou festival?', 'A montagem de palco para show costuma levar entre 8 e 12 horas, dependendo do tamanho da cobertura e da complexidade do grid de iluminação. Palcos menores para convenções levam de 4 a 6 horas.'],
      ['É possível realizar a montagem de palco para festa de casamento em locais fechados?', 'Sim! Ajustamos a montagem de palco para festa de casamento ao espaço disponível no salão ou espaço de eventos, utilizando praticáveis de altura reduzida e acabamentos alinhados à decoração.'],
      ['Como funciona a montagem de palco para formatura em relação à acessibilidade?', 'Na montagem de palco para formatura, instalamos rampas de acesso com corrimão e escadas antiderrapantes para garantir a movimentação segura de formandos, professores e homenageados.'],
      ['A montagem de palco para evento corporativo inclui suporte para LED e som?', 'Sim. Planejamos a montagem de palco para evento corporativo já com os encaixes e suportes para painéis de LED, comunicação visual, sonorização e grid de iluminação.'],
      ['Quais regiões são atendidas para o serviço de montagem de palco?', 'Atendemos São Paulo (SP), Região Metropolitana, Campinas, Baixada Santista e interior do estado.'],
    ],
  },
  {
